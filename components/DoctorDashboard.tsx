...
const DoctorDashboard: React.FC<DoctorDashboardProps> = ({ email, onLogout }) => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.actionsCard}>
        ...
        <TouchableOpacity style={styles.actionButton}>
          <Text style={styles.actionButtonText}>📅 View Today's Schedule</Text>
        </TouchableOpacity>
      ...
      <View style={styles.infoCard}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>General Medicine</Text>
        </View>
      </View>
    </ScrollView>
  );
